...
{
    public static final String ACTION_WIFI_ENABLED = "com.example.mymovies.receivers.WifiReceiver.ACTION_WIFI_ENABLED";
    public static final String ACTION_WIFI_DISABLED = "com.example.mymovies.receivers.WifiReceiver.ACTION_WIFI_DISABLED";
